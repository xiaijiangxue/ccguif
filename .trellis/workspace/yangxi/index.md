...
| 92 | 2026-06-20 | feat(dropdown): add alignOffset prop for horizontal fine-tuning | `7ed1f8c6` | `refactor/liquid-precision-ui` |
| 91 | 2026-06-20 | style(composer): compact selector dropdowns, improve dropdown positioning | `519999bc` | `refactor/liquid-precision-ui` |
...
| 75 | 2026-06-19 | refactor(git-history): move section actions to root folder row | `d8a9db62` | `refactor/liquid-precision-ui` |
...
| 42 | 2026-06-18 | fix(todolist): use display:none for hidden state to preserve animation | `7de31caa` | `refactor/liquid-precision-ui` |
| 41 | 2026-06-18 | feat(todolist): auto-scroll to bottom when new todos are added | `a67c6d53` | `refactor/liquid-precision-ui` |
...
| 14 | 2026-06-06 | 提交工具操作时间线展示优化 | `22d7b197` | `refactor/liquid-precision-ui` |
