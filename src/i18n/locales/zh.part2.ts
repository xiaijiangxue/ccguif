const zhPart2 = {
  ...
  files: {
    ...
    navigationNoImplementation: "当前位置未找到实现（需要 JDTLS）",
    ...
    searchPanelFind: "查找",
    searchPanelReplace: "替换",
    searchPanelMatchCase: "区分大小写",
    searchPanelWholeWord: "全词匹配",
    searchPanelRegexp: "正则表达式",
    searchPanelPrevious: "上一个",
    searchPanelNext: "下一个",
    searchPanelSelectAll: "选中全部",
    searchPanelReplaceAll: "全部替换",
    searchPanelClose: "关闭",
    searchPanelResultCount: "{{count}} 个结果",
    searchPanelResultCountLimit: "{{limit}}+ 个结果",
    closeAllTabs: "关闭全部标签",
