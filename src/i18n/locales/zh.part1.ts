const zhPart1 = {
  ...
  searchPalette: {
    ...
    contentFileContent: "文件内容",
    contentMinLengthTitle: "继续输入以搜索文件内容",
    contentMinLengthHint: "文件内容搜索至少需要 {{count}} 个字符，用来避免每次短输入扫描整个工作区。",
    contentSearching: "正在搜索文件内容...",
    contentMoreAvailable: "继续滚动加载更多文件匹配",
    contentDegraded: "文件内容搜索只返回了部分结果",
    contentDegradedWithReason: "文件内容搜索只返回了部分结果：{{reason}}",
  },
  ...
  sidebar: {
    ...
    dragWorkspace: "拖动项目",
    workspaceDropBefore: "移动到前面",
    workspaceDropAfter: "移动到后面",
    workspaceDropCreateGroup: "创建分组",
    workspaceDropMoveToGroup: "移入分组",
    workspaceGroupCreateTitle: "创建项目分组",
    workspaceGroupCreateSummary: "将“{{source}}”和“{{target}}”放入同一分组，不改变磁盘目录。",
    workspaceGroupNameRequired: "分组名不能为空。",
    workspaceGroupNameDuplicate: "已存在同名分组。",
    apiKey: "API 密钥",
