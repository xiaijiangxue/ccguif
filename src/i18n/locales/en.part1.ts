const enPart1 = {
  ...
  sidebar: {
    ...
    dragWorkspace: "Drag project",
    workspaceDropBefore: "Move before",
    workspaceDropAfter: "Move after",
    workspaceDropCreateGroup: "Create group",
    workspaceDropMoveToGroup: "Move to group",
    workspaceGroupCreateTitle: "Create project group",
    workspaceGroupCreateSummary:
      "Group {{source}} with {{target}} without changing folders on disk.",
    workspaceGroupNameRequired: "Group name is required.",
    workspaceGroupNameDuplicate: "A group with this name already exists.",
    apiKey: "API key",
