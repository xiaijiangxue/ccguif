const enPart2 = {
  ...
  files: {
    ...
    navigationNoImplementation: "No implementation found at current cursor (JDTLS required)",
    ...
    searchPanelFind: "Find",
    searchPanelReplace: "Replace",
    searchPanelMatchCase: "Match case",
    searchPanelWholeWord: "Whole word",
    searchPanelRegexp: "Regular expression",
    searchPanelPrevious: "Previous",
    searchPanelNext: "Next",
    searchPanelSelectAll: "Select all",
    searchPanelReplaceAll: "Replace all",
    searchPanelClose: "Close",
    searchPanelResultCount: "{{count}} results",
    searchPanelResultCountLimit: "{{limit}}+ results",
