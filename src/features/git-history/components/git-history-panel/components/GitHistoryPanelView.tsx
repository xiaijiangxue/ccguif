  ...
  return (
    ...
    >
      ...
      >
        ...
        {desktopSplitLayout && (
          <div
            className="git-history-vertical-resizer is-details-split-bridge"
            role="separator"
            aria-orientation="vertical"
            style={
              detailsSplitConnectorTop === null
                ? undefined
                : { ["--git-history-details-split-y" as string]: `${detailsSplitConnectorTop}px` }
            }
          ...
          <div className="git-history-column-header">
            ...
            {details && (
              <span className="git-history-details-view-toggle" role="group" aria-label={t("git.listView")}>
                <button
                  className={`git-history-overview-list-tab${detailsListView === "flat" ? " is-active" : ""}`}
                  onClick={() => setDetailsListView("flat")}
                >
                  <LayoutGrid size={13} />
                  <span>{t("git.listFlat")}</span>
                </button>
                <button
                  className={`git-history-overview-list-tab${detailsListView === "tree" ? " is-active" : ""}`}
                  onClick={() => setDetailsListView("tree")}
                >
                  <FolderTree size={13} />
                  <span>{t("git.listTree")}</span>
                </button>
