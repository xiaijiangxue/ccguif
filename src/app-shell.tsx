...
export function AppShell() {
  ...
  const appShellContext = {
    ...
    approvals, assignWorkspaceGroup, applyWorkspaceSidebarOrganization, attachImages, baseWorkspaceRef, branches, canFuseActiveQueue, canInterrupt, cancelClonePrompt, cancelWorktreePrompt,
    ...
    commitMessage, commitMessageError, commitMessageLoading, completionEmailIntentByThread, completionTrackerBySessionRef, completionTrackerReadyRef, contentSearchError,
    contentSearchStatus, composerEditorSettings, composerInputRef, composerInsert,
    ...
    hasActivePlan, hasLoaded, hasMoreContentResults, hasPlanData, highlightedBranchIndex, highlightedCommitIndex, highlightedPresetIndex, historySearchItems, hydratedThreadListWorkspaceIdsRef,
    ...
    listThreadsForWorkspace, listThreadsForWorkspaceTracked, liveEditPreviewEnabled, loadMoreContentResults, loadOlderThreadsForWorkspace, lockLiveSessions,
