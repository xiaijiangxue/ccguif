...
- **Code/document evidence**: `@tanstack/react-virtual` 被 Git history/file Markdown 等长列表路径使用，long-list baseline/perf scripts 已存在。
- **Next action**: 归档前补浏览器级/fixture-based virtualization evidence，避免只凭代码符号归档。
